...
--
-- Class Restroom as table restrooms
--
...
--
-- Foreign relations for "ratings" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('restroom', '20240131033325483', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20240131033325483', "timestamp" = now();
